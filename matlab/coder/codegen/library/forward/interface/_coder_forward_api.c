...
void forward_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray
                 *plhs[1])
{
  real_T (*b_y1)[2];
  real_T (*x1)[6];
  ...
  b_y1 = (real_T (*)[2])mxMalloc(sizeof(real_T [2]));
...
void forward_atexit(void)
{
  ...
  forward_xil_terminate();
  forward_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}

void forward_initialize(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/* End of code generation (_coder_forward_api.c) */
